...
namespace Core.Bll
{
    public class ReanudacionBLL : BaseBLL<Reanudacion>
    {

        public ReanudacionBLL(IConfiguration configuration, IHttpContextAccessor httpContext, ProyectoBLL proyectoBLL, UserManager<MongoIdentityUser> userManager) : base(configuration, httpContext)
        {
