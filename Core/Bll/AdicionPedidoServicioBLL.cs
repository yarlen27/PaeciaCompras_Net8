...
namespace Core.Bll
{
    public class AdicionPedidoServicioBLL : BaseBLL<AdicionPedidoServicio>
    {
        public AdicionPedidoServicioBLL(IConfiguration configuration, IHttpContextAccessor httpContext, ProyectoBLL proyectoBLL, UserManager<MongoIdentityUser> userManager) : base(configuration, httpContext)
        {
